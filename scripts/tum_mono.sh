...
../bin/tum_mono \
    ...
    /PRGS-SLAM/data/tum/rgbd_dataset_freiburg1_desk \
...
../bin/tum_mono \
    ...
    ../cfg/gaussian_mapper/Monocular/TUM/tum_mono.yaml \
    /PRGS-SLAM/data/tum/rgbd_dataset_freiburg2_xyz \
...
../bin/tum_mono \
    ...
    ../cfg/gaussian_mapper/Monocular/TUM/tum_mono.yaml \
    /PRGS-SLAM/data/tum/rgbd_dataset_freiburg3_long_office_household \
