...
../bin/replica_mono \
    ...
    /PRGS-SLAM/data/replica/office0 \
...
../bin/replica_mono \
    ...
    ../cfg/gaussian_mapper/Monocular/Replica/replica_mono.yaml \
    /PRGS-SLAM/data/replica/office1 \
...
../bin/replica_mono \
    ...
    ../cfg/gaussian_mapper/Monocular/Replica/replica_mono.yaml \
    /PRGS-SLAM/data/replica/office2 \
...
../bin/replica_mono \
    ...
    ../cfg/gaussian_mapper/Monocular/Replica/replica_mono.yaml \
    /PRGS-SLAM/data/replica/office3 \
...
../bin/replica_mono \
    ...
    ../cfg/gaussian_mapper/Monocular/Replica/replica_mono.yaml \
    /PRGS-SLAM/data/replica/office4 \
